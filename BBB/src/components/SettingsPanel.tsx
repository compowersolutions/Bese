                  ...
                  {THEMES.map((t) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isActive && (
                          <Check className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: 'var(--accent-text)' }} />
                        )}
                      </button>
                    );
                  })}
              ...
              <section>
                ...
                <div className="rounded-xl p-4 space-y-2" style={{ backgroundColor: 'var(--bg-muted)' }}>
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-medium" style={{ color: 'var(--text-primary)' }}>Botswana Bus Booking</span>
                  </div>
                  <div className="flex justify-between text-xs">
                    <span style={{ color: 'var(--text-muted)' }}>Version</span>
                    <span className="font-medium" style={{ color: 'var(--text-primary)' }}>1.0.0</span>
                  </div>
                  <div className="flex justify-between text-xs">
                    <span style={{ color: 'var(--text-muted)' }}>Region</span>
                    <span className="font-medium" style={{ color: 'var(--text-primary)' }}>Botswana 🇧🇼</span>
                  </div>
                  <div className="flex justify-between text-xs">
                    <span style={{ color: 'var(--text-muted)' }}>Currency</span>
                    <span className="font-medium" style={{ color: 'var(--text-primary)' }}>BWP (Pula)</span>
                  </div>
                </div>
              </section>
